/**
 * types.ts
 * TypeScript interfaces for the dual-view data presentation system
 */
...
export interface DualViewPresentationProps {
  ...
  /** ShopifyApiClient instance for Admin API calls */
  apiClient?: any;
  
  /** StorefrontApiClient instance for Storefront API calls */
  storefrontApiClient?: any;
}
