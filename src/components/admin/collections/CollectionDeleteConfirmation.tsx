...
export interface CollectionDeleteConfirmationProps {
  collectionId: string;
...
const CollectionDeleteConfirmation: React.FC<CollectionDeleteConfirmationProps> = ({
  collectionId,
  collectionTitle,
  onConfirm,
  onCancel,
  ...
  // Fetch collection data if title is not provided
  useEffect(() => {
  ...
  }, [collectionId, collectionTitle, collections]);
  ...
  const title = collectionTitle || collection?.title || 'this collection';
  ...
  return (
    <Card className="max-w-md mx-auto">
      <div className="text-center">
        ...
        <h3 className="mt-3 text-lg font-medium">Delete Collection</h3>
        <div className="mt-2">
