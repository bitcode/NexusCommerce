...
export interface DraftOrderDeleteConfirmationProps {
  draftOrderId: string;
...
/**
 * DraftOrderDeleteConfirmation component
 * This component displays a confirmation dialog for deleting a draft order
 */
const DraftOrderDeleteConfirmation: React.FC<DraftOrderDeleteConfirmationProps> = ({
  draftOrderId,
  draftOrderName,
  isOpen,
  onClose,
      ...
      <div className="flex items-center justify-center min-h-screen p-4">
        <div className="relative bg-light-bg dark:bg-dark-bg rounded-lg shadow-xl max-w-md w-full p-6 overflow-hidden">
          ...
          <div className="space-y-4">
            <p>
              Are you sure you want to delete draft order{' '}
              <span className="font-semibold">{draftOrderName || draftOrderId}</span>?
            </p>
              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  <p className="text-sm text-yellow-700 dark:text-yellow-300">
                    This action cannot be undone. This will permanently delete the draft order and all associated data.
                  </p>
                </div>
              </div>
            </div>
...
export default DraftOrderDeleteConfirmation;
